...
const (
	...
	optTerragruntUseParseConfigCache            = "terragrunt-use-parse-config-cache"
...
var allTerragruntBooleanOpts = []string{
	...
	optTerragruntUseParseConfigCache,
...
GLOBAL OPTIONS:
   ...
   terragrunt-use-parse-config-cache            Enables caching of full configs during normal parsing operations. 
